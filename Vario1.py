                ...
                with st.spinner("Calcul du variogramme en cours..."):
                    ...
                    with model_col:
                        ...
                        if len(valid_gamma) > 0:
                            ...
                            if model_type == "Sphérique":
                                st.latex(r"\gamma(h) = \begin{cases} 
                                " + f"{nugget:.{decimal_precision}f}" + r" + " + f"{(sill-nugget):.{decimal_precision}f}" + r" \times \left[ 1.5 \times \frac{h}{" + f"{rang:.{decimal_precision}f}" + r"} - 0.5 \times \left(\frac{h}{" + f"{rang:.{decimal_precision}f}" + r"}\right)^3 \right] & \text{si } h \leq " + f"{rang:.{decimal_precision}f}" + r" \\
                                " + f"{sill:.{decimal_precision}f}" + r" & \text{si } h > " + f"{rang:.{decimal_precision}f}" + r"
                                \end{cases}")
                            elif model_type == "Exponentiel":
                                ...
                                st.latex(r"\gamma(h) = \begin{cases} 
                                " + f"{nugget:.{decimal_precision}f}" + r" + " + f"{(sill-nugget):.{decimal_precision}f}" + r" \times \frac{h}{" + f"{rang:.{decimal_precision}f}" + r"} & \text{si } h \leq " + f"{rang:.{decimal_precision}f}" + r" \\
                                " + f"{sill:.{decimal_precision}f}" + r" & \text{si } h > " + f"{rang:.{decimal_precision}f}" + r"
                                \end{cases}")
